    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alternate_phone', models.CharField(blank=True, max_length=17, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')], verbose_name='Alternate Phone Number')),
                ('country', models.CharField(max_length=100, verbose_name='Country')),
                ('state', models.CharField(max_length=100, verbose_name='State')),
                ('city', models.CharField(max_length=100, verbose_name='City')),
                ('postal_code', models.CharField(blank=True, max_length=20, verbose_name='Postal Code')),
                ('address_line1', models.TextField(blank=True, verbose_name='Address Line 1')),
                ...
                ('facebook_id', models.CharField(blank=True, max_length=100, verbose_name='Facebook ID')),
                ('google_id', models.CharField(blank=True, max_length=100, verbose_name='Google ID')),
                ('profile_completion_percentage', models.PositiveIntegerField(default=0, verbose_name='Profile Completion Percentage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('action', models.CharField(choices=[('CREATE', 'Create'), ('UPDATE', 'Update'), ('DELETE', 'Delete'), ('LOGIN', 'Login'), ('LOGOUT', 'Logout'), ('PAYMENT', 'Payment'), ('RENTAL_CREATE', 'Rental Created'), ('RENTAL_UPDATE', 'Rental Updated'), ('RENTAL_CANCEL', 'Rental Cancelled'), ('PRODUCT_UPDATE', 'Product Updated'), ('USER_UPDATE', 'User Updated')], max_length=50, verbose_name='Action')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_contact_method', models.CharField(choices=[('EMAIL', 'Email'), ('PHONE', 'Phone'), ('SMS', 'SMS')], default='EMAIL', max_length=20, verbose_name='Preferred Contact Method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('STAFF', 'Staff'), ('MANAGER', 'Manager'), ('ADMIN', 'Administrator'), ('SUPER_ADMIN', 'Super Administrator')], max_length=20, verbose_name='Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='role_permissions', to='user.feature', verbose_name='Feature')),
                ('user_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feature_permissions', to='user.userrole', verbose_name='User Role')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddIndex(
            model_name='user',
            index=models.Index(fields=['created_at'], name='user_user_created_c7163e_idx'),
        ),
        migrations.AddIndex(
            model_name='auditlog',
            index=models.Index(fields=['user', 'action', 'created_at'], name='user_auditl_user_id_6f601a_idx'),
        ),
        migrations.AddIndex(
            model_name='auditlog',
            index=models.Index(fields=['model_name', 'object_id'], name='user_auditl_model_n_6d5041_idx'),
        ),
        migrations.AddIndex(
            model_name='otpverification',
            index=models.Index(fields=['email', 'otp_type'], name='user_otpver_email_f00c36_idx'),
        ),
        migrations.AddIndex(
            model_name='otpverification',
            index=models.Index(fields=['phone_number', 'otp_type'], name='user_otpver_phone_n_96dc80_idx'),
        ),
        migrations.AddIndex(
            model_name='otpverification',
            index=models.Index(fields=['expires_at'], name='user_otpver_expires_e2c549_idx'),
        ),
