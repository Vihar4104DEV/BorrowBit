...
class SMTPEmailService:
    ...
    def __init__(self):
        ...
        self.smtp_port = int(os.environ.get('EMAIL_PORT'))
        self.smtp_username = os.environ.get('EMAIL_HOST_USER')
        self.smtp_password = os.environ.get('EMAIL_HOST_PASSWORD')
        self.smtp_use_tls = os.environ.get('EMAIL_USE_TLS', 'True').lower() == 'true'
        self.smtp_use_ssl = os.environ.get('EMAIL_USE_SSL', 'False').lower() == 'true'
